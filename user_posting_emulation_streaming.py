...
class AWSDBConnector:
    ...
    def __init__(self): 
        ...
        """
        The `create_db_connector` function creates a database connector using the provided host, user,
...
def run_infinite_post_data_loop():
    ...
    while True:
        ...
        stream_data(pin_result, geo_result, user_result)


    
def stream_data(pin_result, geo_result, user_result):
    

    invoke_url_pin = 'https://dapwwc6yy2.execute-api.us-east-1.amazonaws.com/test/streams/streaming-1272e2b5acdf-pin/record'
    invoke_url_geo = 'https://dapwwc6yy2.execute-api.us-east-1.amazonaws.com/test/streams/streaming-1272e2b5acdf-geo/record'
    invoke_url_user = 'https://dapwwc6yy2.execute-api.us-east-1.amazonaws.com/test/streams/streaming-1272e2b5acdf-user/record'

    payload_pin = json.dumps({
        'StreamName': 'streaming-1272e2b5acdf-pin',
        'Data': {
    ...
    payload_geo = json.dumps({
        'StreamName': 'streaming-1272e2b5acdf-geo',
        'Data': {
    ...
    payload_user = json.dumps({
        'StreamName': 'streaming-1272e2b5acdf-user',
        'Data': {
